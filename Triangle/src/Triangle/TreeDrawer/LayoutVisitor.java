...
public class LayoutVisitor implements Visitor {
  ...
  public Object visitMatchCommand(MatchCommand ast, Object obj) {
    ...
    if (ast.OTHERWISE != null){
        list.add(ast.OTHERWISE);
    }
    return layoutAny("MatchCom.", list);
  }
  ...
  private DrawingTree layoutQuaternary (String name, AST child1, AST child2,
    ...
    private DrawingTree layoutAny(String name, List<AST> children){
      DrawingTree dt = layoutCaption(name);
      DrawingTree[] c = new DrawingTree[children.size()];
      DrawingTree d;
      AST a;
      
      for (int i = 0; i < children.size(); i++){
          a = children.get(i);
          d = (DrawingTree) a.visit(this, null);
          c[i] = d;
      }
